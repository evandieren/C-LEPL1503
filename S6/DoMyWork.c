/*
Tries to run the first thread with long_computing. If it doesn't work, then we call the second thread with back_up computing which gives us for sure the right answer.
*/
